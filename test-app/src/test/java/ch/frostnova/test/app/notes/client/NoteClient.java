package ch.frostnova.test.app.notes.client;

import ch.frostnova.test.app.notes.api.Note;
import ch.frostnova.test.app.notes.client.config.ResponseExceptionMapper;
import ch.frostnova.test.app.notes.client.config.RestClientConfig;
