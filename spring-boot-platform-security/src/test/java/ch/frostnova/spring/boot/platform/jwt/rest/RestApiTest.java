...
public class RestApiTest {
    ...
    void shouldGetAdminResource() {
        ...
        String jwtUserRole = client.login(baseURL(), "test-tenant", "test-user", Set.of("USER"), null);
        ...
        String jwtAdminRole = client.login(baseURL(), "test-tenant", "test-user", Set.of("ADMIN", "OPERATOR"), null);
